...
public class PushService {
    ...
    public void addKeyword(KeywordRequestDto keywordRequestDto) throws FirebaseMessagingException {
        ...
        Keyword keyword = keywordRepository.findByKeyword(keywordRequestDto.getKeyword())
                .orElse(keywordRequestDto.toEntity(keywordRequestDto));
    ...
    public void setTopic(Member member, String topic) throws FirebaseMessagingException {
        ...
        String fcmToken = getFcmToken(member.getNickname());
        if (fcmToken != null) {
